            ...
            <div id="item-carousel-big" class="owl-carousel wow fadeIn">
                <div class="nft_pic">
                    ...
                    <div class="nft_pic_wrap">
                        <img src="{{asset('front/images/carousel/crs-1.jpg')}}" class="lazy img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="nft_pic">
                    ...
                    <div class="nft_pic_wrap">
                        <img src="{{asset('front/images/carousel/crs-2.jpg')}}" class="lazy img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="nft_pic">
                    ...
                    <div class="nft_pic_wrap">
                        <img src="{{asset('front/images/carousel/crs-3.jpg')}}" class="lazy img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="nft_pic">
                    ...
                    <div class="nft_pic_wrap">
                        <img src="{{asset('front/images/items/anim-5.webp')}}" class="lazy img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="nft_pic">
                    ...
                    <div class="nft_pic_wrap">
                        <img src="{{asset('front/images/items/anim-8.webp')}}" class="lazy img-fluid" alt="">
                    </div>
                </div>
            </div>
