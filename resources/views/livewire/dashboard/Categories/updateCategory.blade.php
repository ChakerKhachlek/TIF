...
<div class="row">
    <div class="col-md-10">
        <div class="h3 text-white">Update Category</div>
    </div>
    <div class="col-md-2">
    ...
    <div class="row py-3">
        <div class="col-md-12">
            ...
            <div class="form-group">
             ...
             <label for="category_img" class="form-label">Image (Required)</label>

             <input wire:model.lazy="category_img" type="file" id="category_img" class="form-control mb-2" accept="image/*">
             <div wire:loading wire:target="category_img">
             ...
             @if (!is_string($category_img))
             Photo Preview:
             <img src="{{ $category_img->temporaryUrl() }}"  height="80px" width="80px" class=" mb-3">
             @endif
